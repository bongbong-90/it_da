...
export const CATEGORY_DATA: Record<CategoryType, { icon: string; description: string; subcategories: { name: string; icon: string; description: string; popular?: boolean }[] }> = {
    스포츠: {
        icon: "🏃",
        description: "건강한 몸과 마음을 위한 다양한 운동 모임",
        subcategories: [
            { name: "러닝", icon: "🏃‍♂️", description: "함께 달리는 즐거움", popular: true },
            { name: "축구", icon: "⚽", description: "팀워크를 기르는 축구" },
            { name: "배드민턴", icon: "🏸", description: "가벼운 운동의 정석" },
            { name: "등산", icon: "⛰️", description: "자연 속에서 호흡", popular: true },
    ...
    맛집: {
        ...
        subcategories: [
            { name: "한식", icon: "🍚", description: "우리의 맛, 한식", popular: true },
            { name: "중식", icon: "🥟", description: "중국의 다양한 요리" },
            { name: "일식", icon: "🍣", description: "일본 정통 맛집" },
            { name: "양식", icon: "🍝", description: "이탈리안, 프렌치 등", popular: true },
    ...
    카페: {
        ...
        subcategories: [
            { name: "카페투어", icon: "☕", description: "핫플 카페 탐방", popular: true },
            { name: "브런치", icon: "🥐", description: "맛있는 브런치" },
            { name: "디저트", icon: "🍰", description: "달콤한 디저트", popular: true },
    ...
    문화예술: {
        ...
        subcategories: [
            { name: "전시회", icon: "🖼️", description: "다양한 전시 관람", popular: true },
            { name: "공연", icon: "🎭", description: "뮤지컬, 연극 등" },
            { name: "갤러리", icon: "🏛️", description: "갤러리 투어" },
            { name: "공방체험", icon: "🎨", description: "손으로 만드는 예술", popular: true },
    ...
    스터디: {
        ...
        subcategories: [
            { name: "영어회화", icon: "🗣️", description: "실전 영어 회화", popular: true },
            { name: "독서토론", icon: "📖", description: "함께 읽고 토론" },
            { name: "코딩", icon: "💻", description: "프로그래밍 스터디", popular: true },
    ...
    취미활동: {
        ...
        subcategories: [
            { name: "그림", icon: "🎨", description: "드로잉, 페인팅", popular: true },
    ...
    소셜: {
        ...
        subcategories: [
            { name: "보드게임", icon: "🎲", description: "보드게임 카페", popular: true },
    ...
    useEffect(() => {
        const fetchStats = async () => {
            try {
                ...
                const catStats = stats[categoryName] as CategoryDetailStatsItem | undefined;
